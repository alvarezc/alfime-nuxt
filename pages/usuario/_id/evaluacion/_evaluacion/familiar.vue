<template>
    <v-container>
        ...
        <v-switch label="La familia es conciente de las limitaciones del usuario?" v-model="modelo.actitud1"></v-switch>
        ...
        <v-dialog v-model="dialog" max-width="500px">
            <v-btn color="primary" dark slot="activator" class="mb-2" :disabled="modelo.id === -1">Agregar</v-btn>

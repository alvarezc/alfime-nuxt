<template>
    <v-card>
        <v-card-title primary-title>
            <div class="headline">Seguridad Social</div>
        </v-card-title>
        ...
        <v-card-actions>
            ...
            <v-btn flat color="red" exact :to="`/usuario/${$route.params.id}/evaluacion/${$route.params.evaluacion}`">
                Cerrar
            </v-btn>
        </v-card-actions>

        <h3>Tipo de servicio al cual asiste</h3>
